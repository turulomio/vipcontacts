<template>
    <div>
        ...
        <v-card  class="login">
            ...
            <AutoCompleteApiOneField v-model="selected.profession" v-bind:label="$t('Profession')" required v-bind:placeholder="$t('Enter a profession')" :apiurl="`${this.$store.state.apiroot}/api/professions/`" field="profession" />
            <v-text-field v-model="selected.organization" type="text" :counter="75"  v-bind:label="$t('Organization')" required v-bind:placeholder="$t('Enter an organization')" ></v-text-field>
            <v-text-field v-model="selected.department" type="text" :counter="75"  v-bind:label="$t('Department')" required v-bind:placeholder="$t('Enter a department')" ></v-text-field>
            <v-text-field v-model="selected.title" type="text" :counter="75"  v-bind:label="$t('Title')" required v-bind:placeholder="$t('Enter a title')" ></v-text-field>            
