<template>
    <div>
        ...
        <v-card  class="login">
            ...
            <AutoCompleteApiOneField v-model="selected.organization" v-bind:label="$t('Organization')" v-bind:placeholder="$t('Enter a organization')" :apiurl="`${this.$store.state.apiroot}/api/organizations/`" field="organization" />
